...
public:
  ...
  /// Returns the max constant multiple of S. A special case is if S is exactly
  /// 0, any number is a valid multiple, but this function just returns 0.
...
private:
  ...
  /// Memoized values for the getMaxConstantMultiple
  DenseMap<const SCEV *, APInt> MaxConstantMultipleCache;
